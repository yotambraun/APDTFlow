import torch
from apdtflow.models.dynamics import HierarchicalNeuralDynamics, adaptive_hierarchical_ode_solver
...
def test_adaptive_ode_solver():
    ...
    h_sol, logvar_sol = adaptive_hierarchical_ode_solver(dynamics, h0, logvar0, t_span, x_seq)
