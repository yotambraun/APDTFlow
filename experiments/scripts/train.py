...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train a forecasting model with APDTFlow framework.")
    parser.add_argument('--csv_file', type=str, required=True, help='Path to the CSV file with data.')
    parser.add_argument('--date_col', type=str, default="DATE", help='Name of the date column.')
    parser.add_argument('--value_col', type=str, required=True, help='Name of the value column.')
    parser.add_argument('--T_in', type=int, default=12, help='Length of input sequence.')
    parser.add_argument('--T_out', type=int, default=3, help='Forecast horizon (number of future time steps).')
    parser.add_argument('--model', type=str, default='APDTFlow', help='Forecasting model to use.')
    parser.add_argument('--num_scales', type=int, default=3, help='Number of scales in APDTFlow.')
    parser.add_argument('--filter_size', type=int, default=5, help='Filter size for dynamic dilation convolution.')
