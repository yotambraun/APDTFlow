...
it cross the line?** The answer comes with a calibrated uncertainty window on the time itself.
...
crossing-time errors (time space), not value bands; that distinction is what makes
...
on *your* data. If APDTFlow wins, open a PR and we will feature your domain with your
