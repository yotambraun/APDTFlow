...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run inference with the forecasting model.")
    ...
    parser.add_argument('--num_scales', type=int, default=3, help='Number of scales (for APDTFlow).')
    parser.add_argument('--filter_size', type=int, default=5, help='Filter size for convolution.')
